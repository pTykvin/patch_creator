...
opt/deleter.o: src/deleter.c
	gcc -c src/deleter.c -o opt/deleter.o 		
...
deleter: opt/deleter.o
	gcc opt/deleter.o -o deleter	
install: dir_tree differencer analizer checkouter copier libs_differ deleter